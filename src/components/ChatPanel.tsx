    ...
    <div className="flex flex-col gap-3 text-sm">
      <div className="rounded-md border border-amber-200 bg-amber-50 p-2.5 text-xs text-amber-900 dark:border-amber-900/50 dark:bg-amber-950/30 dark:text-amber-200">
        ...
        <ul className="mt-1 list-disc space-y-0.5 pl-4">
          ...
          <li>By default the key is saved only in this browser&apos;s local storage so you don&apos;t have to re-enter it; you can opt out of that below, or forget it any time. Each provider&apos;s key is stored separately.</li>
